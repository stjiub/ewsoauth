...
namespace EwsOAuth
{
    [Cmdlet(VerbsCommon.Get, "MailboxManagedFolder")]
    [OutputType(typeof(Folder))]
    public class GetMailboxManagedFolder : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            WriteVerbose("Getting managed folder...");
            var managedFolder = ManagedFolders.GetManagedFolder(ewsClient, FolderName);
            WriteObject(managedFolder);
        }
