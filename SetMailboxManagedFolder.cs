...
namespace EwsOAuth
{
    [Cmdlet(VerbsCommon.Set, "MailboxManagedFolder")]
    public class SetMailboxManagedFolder : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            ManagedFolders.SetManagedFolderTag(ewsClient, Identity, FolderName, RetentionTagGuid);
        }
